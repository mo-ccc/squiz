...
cprint(f"Awesome you have selected {category_name} "
       "as your category!", main_color)
...
if len(raw_questions) == 0:
    cprint("Sorry but we couldn't find any questions "
           "to build your quiz", main_color)
    exit()
